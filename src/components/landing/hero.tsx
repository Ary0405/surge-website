    ...
    <MotionBox style={{ opacity }}>
      ...
      >
        <Text
          ...
          fontWeight={400}
          fontSize={{ base: "40px", sm: "50px", md: "60px", lg: "60px", xl: "70px" }}
        ...
        <Text mt={{ base: "1rem", sm: "1.5rem", md: "2rem", lg: "2.5rem", xl: "3rem" }}
          fontSize={{ base: "18px", sm: "19px", md: "20px", lg: "21px", xl: "22px" }}
          lineHeight="1.3" textAlign="center" maxW="80%">
        ...
        <Button
          mt={{ base: "3rem", sm: "3.5rem", md: "4rem", lg: "4.5rem", xl: "5rem" }}
          p={{ base: "24px", sm: "25.5px", md: "27px", lg: "28.5px", xl: "30px" }}
          fontSize={{ base: "18px", sm: "16px", md: "18px", lg: "20px", xl: "20px" }}
          colorScheme="yellow"
          color="#fff"
          bgColor="#F4AC17"
          _hover={{
        ...
        <Box
          ...
          height={{ base: "20x", sm: "25px", md: "30px", lg: "35px", xl: "40px" }}
